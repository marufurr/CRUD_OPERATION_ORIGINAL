...
<input type="text" class="form-control" rows="1" name="name" value= "{{ $edit->name }}">
</div> 
<div class="form-group">
<label for="text" class="bmd-label-floating" >Email</label>
<input type="text" class="form-control" rows="1" name="email" value= "{{ $edit->email }}">
</div>
<div class="form-group">
<label for="text" class="bmd-label-floating">Phone</label>
<input class="form-control" rows="1" name="phone" value= "{{ $edit->phone }}">

<div class="form-group">
<label for="text" class="bmd-label-floating">Description</label>
<input class="form-control" rows="1" name="description" value="{{ $edit->description }}">
</div>
